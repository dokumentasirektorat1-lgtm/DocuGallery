...
export function AdminForm({ initialData, onSubmit, onCancel, isEditing = false }: AdminFormProps) {
    ...
    useEffect(() => {
        if (initialData) {
            ...
            setDriveLink(initialData.driveFolderId) // Simplified mapping
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        onSubmit?.({
            ...
            isPrivate,
            // category: "Project", // Defaulting for now
            // thumbnailUrl: "", // Logic to be handled
            status: "Synced"
        })
    }
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6 bg-surface p-6 rounded-2xl border border-border shadow-md sticky top-24">
            ...
            <div className="space-y-4">
                ...
                {/* Thumbnail section omitted for brevity, keeping logic simple for now */}
            </div>
